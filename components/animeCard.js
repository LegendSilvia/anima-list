...
export default function AnimeCard({ anime }) {
    ...
    return (
        <div key={animeId} className="relative w-full sm:w-72 md:w-96 h-162 bg-gray-900 rounded-lg overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-105">
